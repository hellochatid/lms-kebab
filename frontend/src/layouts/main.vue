          ...
          <div class="row">
            <div class="col-sm-6 col-md-6 col-md-3 col-lg-3">
              <div class="footer_contact_widget">
                ...
                <p>Kebab adalah lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
              </div>
            </div>
...
.home3_bgi6 {
  background-image: url(https://i.imgur.com/0jWa3Js.jpg);
...
.home3_wave:before {
  background-image: url(https://i.imgur.com/3vV79YD.png);
  background-position: center center;
  background-size: cover;
  content: "";
  height: 250px;
...
.home3_wave:after {
  background-image: url(https://i.imgur.com/NmDFtSU.png);
  background-position: center center;
  background-size: cover;
  content: "";
  height: 400px;
...
.home8_wave:before {
  background-image: url(https://i.imgur.com/NJsKvfc.png);
  background-repeat: no-repeat;
  content: "";
  height: 250px;
  left: -375px;
...
.home8_wave:after {
  background-image: url(https://i.imgur.com/W8ruLsI.png);
  background-repeat: no-repeat;
  content: "";
  height: 1300px;
  position: absolute;
...
.home1-divider2 {
  background-image: url(https://i.imgur.com/bmVb7f2.jpg);
  -webkit-background-size: cover;
  background-position: center center;
  background-size: cover;
  overflow: hidden;
...
.footer_one.home3:before {
  background-image: url(https://i.imgur.com/5Ouvsnt.png);
  bottom: 0;
  content: "";
  left: 0;
  position: absolute;
...
.footer_one.home8:before {
  background-image: url(https://i.imgur.com/qWuJiuK.png);
  -webkit-background-size: cover;
  background-size: cover;
  background-position: center center;
  bottom: 0;
...
/*== BackGround Images ==*/
.bg-img2 {
  background-image: url("https://i.imgur.com/9KDtryZ.png");
}
.bg-img5 {
...
.bg-img6 {
  background-attachment: scroll;
  background-image: url("https://i.imgur.com/1uWDmM6.jpg");
  background-position: center;
  background-repeat: no-repeat;
  height: 960px;
}
...
.preloader {
  background-color: #ffffff;
  background-image: url("https://i.imgur.com/brpEGYS.gif");
  background-position: center center;
  background-repeat: no-repeat;
  height: 100%;
  left: 0px;
...
.divider_home1:before {
  background-color: rgba(92, 45, 140, 0.8);
  content: "";
  height: 100%;
  left: 0;
  position: absolute;
...
.divider2:before {
  background-image: url(https://i.imgur.com/SqAyEqP.png);
  background-repeat: no-repeat;
  bottom: 0;
  content: "";
  left: 0;
