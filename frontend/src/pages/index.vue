<template>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="home5_slider">
            <div class="item">
              <div class="home-text">
                <h2>Learn to be <span class="text-thm">a Pro!</span></h2>
                <p>Find courses that will make you a reliable Chef with Head Chef of Turki Kebab franchise Baba Rafi, only in the Helocourse</p>
  ...
  <section id="about" class="home3_about2 pb40 pt20">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <div class="about2_home3">
            <h3>What is Kebab?</h3>
            <p>Kebab is a learning management system that lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
          </div>
        </div>
        <div class="col-lg-7">
          <div class="about_thumb_home3 text-right">
            <img class="img-fluid" src="https://i.imgur.com/0SpvMR6.png" alt="7.png">
          </div>
        </div>
      </div>
      <div class="row">
  ...
  <section id="features" class="our-courses">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
            <h3 class="mt0">Why Choose Kebab Course?</h3>
            <p>Some reason why choose Kebab to learn to be a kebab master!</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
          ...
          <div class="material-icons icon">
            ...
            <div class="overlay">
              <div class="details">
                ...
                <p>Lessons adapt to your learning style. Quizes are tailored to help you learn effectively.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="material-icons icon">
            ...
            <div class="overlay">
              <div class="details">
                ...
                <p>Lessons is accessible with various device, desktop, mobile.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          ...
          <div class="material-icons icon">
            ...
            <div class="overlay">
              <div class="details">
                <h5>Tons of materials</h5>
                <p>There's a lot of material for your lesson, access to our exclusive video, audio and document file.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="material-icons icon">
            ...
            <div class="overlay">
              <div class="details">
                ...
                <p>Offering an affordable price for you, you can select your plans based from your budget.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="pricing" class="our-pricing bgc-fa">
    <div class="container">
