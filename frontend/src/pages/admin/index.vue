<template>
  <div>
    ...
    <a href="/admin/courses/add" class="btn btn-primary btn-action btn-icon-text">
        ...
        <div class="card bg-gradient-danger card-img-holder text-white">
          <div class="card-body">
            ...
            <h4 class="font-weight-normal mb-3">
              Total Affiliate
              <i class="material-icons icon mdi-24px float-right">supervisor_account</i>
            </h4>
      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
          <div class="card-body">
            ...
            <h4 class="font-weight-normal mb-3">
              Total student
              <i class="material-icons icon mdi-24px float-right">local_library</i>
            </h4>
        ...
        <div class="card bg-gradient-success card-img-holder text-white">
          <div class="card-body">
            ...
            <h4 class="font-weight-normal mb-3">
              Total revenue
              <i
                class="material-icons icon mdi-24px float-right"
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <i class="material-icons icon text-success">arrow_upward</i>
                    </td>
                  </tr>
                  <tr>
                    <td>2</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <i class="material-icons icon text-danger">arrow_downward</i>
                    </td>
                  </tr>
                  <tr>
                    <td>4</td>
                    ...
                    <td>
                      <i class="material-icons icon text-secondary">drag_handle</i>
                    </td>
                  </tr>
                  <tr>
                    <td>5</td>
